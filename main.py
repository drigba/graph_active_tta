...
def main(config_dict: DictConfig) -> None:
    ...
    for split_idx in range(num_splits):
        ...
        for init_idx in range(config.model.num_inits):
            ...
            initial_train_idxs = initial_acquisition(initial_predictor, config, dataset, generator)
            ...
            for acquisition_step in iterator:
                ...
                with torch.no_grad():
                    ...
                    acquired_idxs, acquisition_metrics = acquisition_strategy.acquire(model, dataset, prediction, config.acquisition_strategy.num_to_acquire_per_step, config.model, generator)
